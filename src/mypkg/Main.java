...
public class Main {
	...
	public static void main(String[] args) {
		...
		// (2) Place "counter++;" command after your contribution, to keep
		// count.
		...
		System.out.println("Hello! its me, Thomas Schlicher;" + " Starbucks coffee + Java = GREATNESS!");
		counter++;

		System.out.println("Hey, it's Kevin Kirkfield.");
		counter++;
